'''
  ...
  Andrew's modifications:
    - Don't use eyes
    - Remove LRN layers
    - Change ITrackerImageModel to only use 2 relatively small conv. layers
    - Only use 1 FC layer for the face image
    - Only use 1 FC layer at the end to join everything
...
class ITrackerModel(nn.Module):
    ...
    def forward(self, faces, eyesLeft, eyesRight, faceGrids):
        # No eyes, just fill the eyes with 0s
