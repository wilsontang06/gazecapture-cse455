# prepareData modified to be called as a function and without dot
...
def prepareInput(dataset_path, output_path):
    args = ArgsMaker(dataset_path, output_path)
    ...
    meta['labelTest'] = np.ones((len(meta['labelRecNum'],)),np.bool) # default choice

    print("meta.labelTrain", meta['labelTrain'])
    print("meta.labelVal", meta['labelVal'])
    print("meta.labelTest", meta['labelTest'])
